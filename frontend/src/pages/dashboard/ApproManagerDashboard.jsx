...
const ApproManagerDashboard = () => {
  ...
  // Polling commandes (pour refléter en temps réel les approvals super admin)
  useEffect(() => {
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh", bgcolor: "black", position: "relative" }}>
      ...
      >
        ...
        {/* ── Welcome Section ── */}
        <Box sx={{ width: "100%", py: 2, px: 2, borderBottom: "1px solid rgba(59, 130, 246, 0.1)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <Box>
          ...
          <Box sx={{ display: "flex", gap: 2 }}>
            <Button
              variant="contained"
              startIcon={<AddIcon />}
              onClick={() => navigate("/appro/fournisseurs/all?add=true")}
              sx={{
                bgcolor: "#3b82f6",
                color: "white",
                fontWeight: 600,
